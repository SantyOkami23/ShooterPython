...
pygame.display.set_caption('Santy')
...
#pygame.mixer.music.load('audio\music1.mp3')
#C:\Users\santi\OneDrive - Universidad Tecnológica de Pereira\Desktop\Semestre 7\ORDENAR\Shooter-main1\audio\music1.mp3
...
class Soldier(pygame.sprite.Sprite):
	...
	def shoot2(self):
		if self.shoot_cooldown == 0 and self.ammo > 0:
			self.shoot_cooldown = 20
			bullet2 = Bullet(self.rect.centerx + (0.75 * self.rect.size[0] * self.direction), self.rect.centery, self.direction)
			...
			for x, tile in enumerate(row):
				if tile >= 0:
					...
					if tile >= 0 and tile <= 8:
						...
						health_bar = HealthBar(20, 10, player.health, player.health)
		...
		if self.timer <= 0:
			...
			for enemy in enemy_group:
				if abs(self.rect.centerx - enemy.rect.centerx) < TILE_SIZE * 2 and \
					...
					enemy.health -= 50
			for enemy2 in enemy2_group:
				if abs(self.rect.centerx - enemy2.rect.centerx) < TILE_SIZE * 2 and \
					abs(self.rect.centery - enemy2.rect.centery) < TILE_SIZE * 2:
					enemy2.health -= 50
